  ...
  up () {
    ...
    this.schedule(async (trx) => {
      ...
      let rows = [
        ...
        {ni_id:450,menuname:"权限管理",parent_id:0,controller:"/role",runStatus:0,menu_sort:100},
        {ni_id:451,menuname:"角色列表",parent_id:450,controller:"/role/list",runStatus:0,menu_sort:100},
        {ni_id:452,menuname:"增加角色",parent_id:450,controller:"/role/add",runStatus:0,menu_sort:100},
        {ni_id:453,menuname:"编辑角色",parent_id:450,controller:"/role/edit",runStatus:1,menu_sort:100},
        {ni_id:454,menuname:"删除角色",parent_id:450,controller:"/role/destroy",runStatus:1,menu_sort:100},
